...
class EfficientNet(tf.keras.Model):
  """Creates an EfficientNet family export.

  This implements the EfficientNet export from:
  ...
  def __init__(self,
               ...
               **kwargs):
    """Initializes an EfficientNet export.

    Args:
      model_id: A `str` of export ID of EfficientNet.
  ...
  def _block_group(self,
    ...
    """Creates one group of blocks for the EfficientNet export.
