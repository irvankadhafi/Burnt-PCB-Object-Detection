...
class ResNet3D(tf.keras.Model):
  """Creates a 3D ResNet family export."""
  ...
  def __init__(
      ...
      **kwargs):
    """Initializes a 3D ResNet export.

    Args:
      model_id: An `int` of depth of ResNet backbone export.
  ...
  def _block_group(self,
    ...
    """Creates one group of blocks for the ResNet3D export.
