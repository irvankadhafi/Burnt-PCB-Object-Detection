...
class RevNet(tf.keras.Model):
  """Creates a Reversible ResNet (RevNet) family export.
  ...
  def __init__(
      ...
      **kwargs):
    """Initializes a RevNet export.

    Args:
      model_id: An `int` of depth/id of ResNet backbone export.
  ...
  def _block_group(self,
    ...
    """Creates one reversible block for RevNet export.
