...
class DilatedResNet(tf.keras.Model):
  """Creates a ResNet export with Deeplabv3 modifications.
  ...
  def __init__(
      ...
      **kwargs):
    """Initializes a ResNet export with DeepLab modification.

    Args:
      model_id: An `int` specifies depth of ResNet backbone export.
