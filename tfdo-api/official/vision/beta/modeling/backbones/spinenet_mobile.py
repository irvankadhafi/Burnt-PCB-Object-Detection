...
class SpineNetMobile(tf.keras.Model):
  """Creates a Mobile SpineNet family export.
  ...
  def __init__(
      ...
      **kwargs):
    """Initializes a Mobile SpineNet export.
    ...
    Args:
      ...
      block_specs: The block specifications for the SpineNet export discovered by
        NAS.
      ...
      filter_size_scale: A `float` of multiplier for the filters (number of
        ...
        of parameters or computation cost of the export.
  ...
  def _block_group(self,
    ...
    """Creates one group of blocks for the SpineNet export."""
  ...
  def output_specs(self):
    """A dict of {level: TensorShape} pairs for the export output."""
