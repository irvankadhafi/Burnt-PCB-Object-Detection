...
def register_model_builder(key: str):
  """Decorates a builder of export class.
  ...
  Returns:
    ...
    for creation from an instance of export class.
  """
...
def build_model(
  ...
  Args:
    model_type: string name of export type. It should be consistent with
...
def build_video_classification_model(
    ...
    num_classes: int,
    l2_regularizer: tf.keras.regularizers.Regularizer = None) -> tf.keras.Model:
  """Builds the video classification export."""
