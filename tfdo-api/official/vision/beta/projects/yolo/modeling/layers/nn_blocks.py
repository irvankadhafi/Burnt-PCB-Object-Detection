...
class ConvBN(tf.keras.layers.Layer):
  ...
  def get_config(self):
    # used to store/share parameters to reconstruct the export
    layer_config = {
        'filters': self._filters,
        'kernel_size': self._kernel_size,
        'strides': self._strides,
...
class CSPRoute(tf.keras.layers.Layer):
  ...
  export to a CSPNet. At the start of a new level change, this CSPRoute layer
  ...
  def __init__(
    ...
    Args:
      ...
      block_invert: bool use for switching between the even and odd
        ...
        ordering typically used when the export requires an odd number
