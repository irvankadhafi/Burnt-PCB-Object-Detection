...
class LogisticModel():
  """Logistic export with L2 regularization."""

  def create_model(self, model_input, vocab_size, l2_penalty=1e-8):
    """Creates a logistic export.
    ...
    Returns:
      ...
      export in the 'predictions' key. The dimensions of the tensor are
...
class MoeModel():
  ...
  def create_model(self,
                   ...
                   num_mixtures=None,
                   l2_penalty=1e-8):
    """Creates a Mixture of (Logistic) Experts export.

     The export consists of a per-class softmax distribution over a
    ...
    Returns:
      ...
      of the export in the 'predictions' key. The dimensions of the tensor
