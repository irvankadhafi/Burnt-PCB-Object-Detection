...
def calculate_hit_at_one(predictions, actuals):
  ...
  Args:
    predictions: Matrix containing the outputs of the export. Dimensions are
      'batch' x 'num_classes'.
...
def top_k_by_class(predictions, labels, k=20):
  ...
  Args:
    predictions: A numpy matrix containing the outputs of the export. Dimensions
...
class EvaluationMetrics(object):
  ...
  def accumulate(self, predictions, labels):
    ...
    Args:
      predictions: A numpy matrix containing the outputs of the export.
        Dimensions are 'batch' x 'num_classes'.
