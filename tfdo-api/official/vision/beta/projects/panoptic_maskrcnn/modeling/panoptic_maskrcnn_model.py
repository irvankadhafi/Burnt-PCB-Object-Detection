...
class PanopticMaskRCNNModel(maskrcnn_model.MaskRCNNModel):
  """The Panoptic Segmentation export."""
  ...
  def __init__(self,
               ...
               **kwargs):
    """Initializes the Panoptic Mask R-CNN export.
    ...
    Args:
      ...
      segmentation_backbone: `tf.keras.Model`, the backbone network for the
        ...
        MaskRCNN export and segmentation head.
      segmentation_decoder: `tf.keras.Model`, the decoder network for the
        ...
        MaskRCNN export and segmentation head. Decoders can only be shared when
