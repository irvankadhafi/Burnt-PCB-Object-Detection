...
# Block specs specify the architecture of each export
BLOCK_SPECS = {
    'a0': (
...
class Movinet(tf.keras.Model):
  """Class to build Movinet family export.
  ...
  def __init__(self,
    ...
    Args:
      model_id: name of MoViNet backbone export.
      ...
      conv_type: '3d', '2plus1d', or '3d_2plus1d'. '3d' configures the network
        ...
        by 5x1x1 conv).
      input_specs: the export input spec to use.
  ...
  def _get_initial_state_shapes(
    ...
    Args:
      block_specs: sequence of specs used for creating a export.
      input_shape: the expected 5D shape of the image input.
      use_positional_encoding: whether the export will use positional encoding.
  ...
  def use_external_states(self) -> bool:
    """Whether this export is expecting input states as additional input."""
