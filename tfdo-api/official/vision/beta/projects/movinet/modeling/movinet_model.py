...
class MovinetClassifier(tf.keras.Model):
  ...
  def __init__(
    ...
    Args:
      ...
      output_states: if True, output intermediate states that can be used to run
          the export in streaming mode. Inputting the output states of the
  ...
  def backbone(self) -> tf.keras.Model:
    """Returns the backbone of the export."""
...
def build_movinet_model(
  ...
  """Builds movinet export."""
  logging.info('Building movinet export with num classes: %s', num_classes)
  if l2_regularizer is not None:
    logging.info('Building movinet export with regularizer: %s',
