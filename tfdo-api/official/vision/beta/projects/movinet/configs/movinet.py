...
MoViNets are efficient video classification networks that are part of a export
family, ranging from the smallest export, MoViNet-A0, to the largest export,
MoViNet-A6. Each export has various width, depth, input resolution, and input
