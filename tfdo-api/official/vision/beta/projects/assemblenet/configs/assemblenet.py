...
# This is the export used in the experiments in the AssembleNet++ paper.
...
# AssembleNet-50 export instead with assemblenet_plus.py code.
...
# the connection weights as [], the export could alos automatically learn the
