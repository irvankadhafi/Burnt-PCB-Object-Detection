...
class SemanticSegmentation3DTask(base_task.Task):
  ...
  def build_model(self) -> tf.keras.Model:
    ...
    # Create a dummy input and call export instance to initialize the export. This
    # is needed when launching multiple experiments using the same export
    # directory. Since there is already a trained export, forward pass will not
    # run and the export will never be built. This is only done when spatial
