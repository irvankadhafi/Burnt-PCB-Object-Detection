...
class UNet3DDecoder(tf.keras.Model):
  ...
  def __init__(self,
    ...
    Args:
      model_id: The depth of UNet3D backbone export. The greater the depth, the
        more max pooling layers will be added to the export. Lowering the depth
      ...
      use_deconvolution: If set to True, the export will use transpose
