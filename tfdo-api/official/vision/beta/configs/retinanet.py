...
def retinanet_spinenet_coco() -> cfg.ExperimentConfig:
  ...
  config = cfg.ExperimentConfig(
      ...
      restrictions=[
          'task.train_data.is_training != None',
          'task.validation_data.is_training != None',
          'task.export.min_level == task.export.backbone.spinenet.min_level',
          'task.export.max_level == task.export.backbone.spinenet.max_level',
      ])
...
def retinanet_spinenet_mobile_coco() -> cfg.ExperimentConfig:
  ...
  config = cfg.ExperimentConfig(
      ...
      restrictions=[
          'task.train_data.is_training != None',
          'task.validation_data.is_training != None',
          'task.export.min_level == task.export.backbone.spinenet_mobile.min_level',
          'task.export.max_level == task.export.backbone.spinenet_mobile.max_level',
      ])
