...
def export_inference_graph(
  ...
  """Exports inference graph for the export specified in the exp config.

  Saved export is stored at export_dir/saved_model, checkpoint is saved
