...
class ExportModule(export_base.ExportModule, metaclass=abc.ABCMeta):
  ...
  def __init__(self,
    ...
    Args:
      ...
      batch_size: The batch size of the export input. Can be `int` or None.
  ...
  def _build_model(self, **kwargs):
    """Returns a export built from the params."""
    return None
    ...
    with tf.device('cpu:0'):
      images = tf.nest.map_structure(
          ...
          tf.map_fn(
              ...
              # be adjusted to conform to the input layer of the export,
