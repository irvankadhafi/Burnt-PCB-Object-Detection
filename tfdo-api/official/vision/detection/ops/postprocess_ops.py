...
"""Post-processing export outputs to generate detection."""
...
def _generate_detections(boxes,
  ...
  """Generate the final detections given the export outputs.
  ...
  Args:
    ...
    scores: a tensor with shape [batch_size, N, num_classes], which stacks class
      ...
      export. Note that the class_outputs here is the raw score.
...
def _generate_detections_per_image(boxes,
                                   ...
                                   score_threshold=0.05,
                                   pre_nms_num_boxes=5000):
  """Generate the final detections per image given the export outputs.
  ...
  Args:
    ...
    scores: a tensor with shape [N, num_classes], which stacks class probability
      ...
      The num_classes is the number of classes predicted by the export. Note that
