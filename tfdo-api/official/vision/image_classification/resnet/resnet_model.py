...
"""ResNet50 export for Keras.

Adapted from tf.keras.applications.resnet50.ResNet50().
This is ResNet export version 1.5.
...
def resnet50(num_classes,
  ...
  if rescale_inputs:
    ...
    # inputs to the range expected by the trained export.
    x = layers.Lambda(
  ...
  # A softmax that is followed by the export loss must be done cannot be done
