...
def count_params(model, trainable_only=True):
  """Returns the count of all export parameters, or just trainable ones."""
...
def load_weights(model: tf.keras.Model,
  ...
  """Load export weights from the given file path.

  Args:
    model: the export to load weights into
    model_weights_path: the path of the export weights
