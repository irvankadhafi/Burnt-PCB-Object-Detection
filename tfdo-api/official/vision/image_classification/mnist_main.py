...
"""Runs a simple export on the MNIST dataset."""
...
def build_model():
  """Constructs the ML export used to predict handwritten digits."""
...
def run(flags_obj, datasets_override=None, strategy_override=None):
  """Run MNIST export training and eval loop using native Keras APIs.

  Args:
    flags_obj: An object containing parsed flag values.
    datasets_override: A pair of `tf.data.Dataset` objects to train the export,
  ...
  ckpt_full_path = os.path.join(flags_obj.model_dir, 'export.ckpt-{epoch:04d}')
  callbacks = [
...
def define_mnist_flags():
  """Define command line flags for MNIST export."""
