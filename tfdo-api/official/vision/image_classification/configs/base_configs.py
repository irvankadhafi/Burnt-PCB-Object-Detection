...
class TrainConfig(hyperparams.Config):
  ...
  Attributes:
    ...
    set_epoch_loop: Whether or not to set `steps_per_execution` to
      equal the number of training steps in `export.compile`. This reduces the
...
class ModelConfig(hyperparams.Config):
  ...
  Attributes:
    name: The name of the export. Defaults to None.
    model_params: The parameters used to create the export. Defaults to None.
    num_classes: The number of classes in the export. Defaults to None.
