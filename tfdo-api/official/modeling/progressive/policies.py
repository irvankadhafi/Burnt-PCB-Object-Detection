...
To write a progressive export, subclass ProgressivePolicy and implement its
...
class ProgressivePolicy:
  ...
  Attributes:
    cur_model: The export for the current progressive training stage.
  ...
  def get_model(self,
    ...
    """Return export for this stage. For initialization, `old_model` = None."""
    pass
