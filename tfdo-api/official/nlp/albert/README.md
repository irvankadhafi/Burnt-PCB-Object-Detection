...
```python
init_checkpoint='the pretrained export checkpoint path.'
model=tf.keras.Model() # Bert pre-trained export as feature extractor.
...
python ../data/create_finetuning_data.py \
 ...
 --sp_model_file=${ALBERT_DIR}/30k-clean.export \
