...
class BertEncoder(tf.keras.Model):
  ...
  embedding lookups and transformer layers, but not the masked language export
  ...
  *Note* that the network is constructed by
  ...
  def from_config(cls, config, custom_objects=None):
    if 'embedding_layer' in config and config['embedding_layer'] is not None:
      warn_string = (
          'You are reloading a export that was saved with a '
          'potentially-shared embedding layer object. If you contine to '
          'train this export, the embedding layer will no longer be shared. '
          'To work around this, load the export outside of the Keras API.')
