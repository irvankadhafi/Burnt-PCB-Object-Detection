...
class BertEncoderTest(keras_parameterized.TestCase):
  ...
  def test_network_invocation(self, output_range, out_seq_len):
    ...
    # Create a export based off of this network:
    model = tf.keras.Model([word_ids, mask, type_ids], [data, pooled])

    # Invoke the export. We can't validate the output data here (the export is too
  ...
  def test_serialize_deserialize(self):
    ...
    # Tests export saving/loading.
    model_path = self.get_temp_dir() + "/export"
