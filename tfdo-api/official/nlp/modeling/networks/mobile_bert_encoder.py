...
class MobileBERTEncoder(tf.keras.Model):
  ...
  def __init__(self,
    ...
    Args:
      ...
      num_blocks: Number of transformer block in the encoder export.
      ...
      normalization_type: The type of normalization_type, only `no_norm` and
        ...
        transformation for the student export, as suggested by the original
        MobileBERT paper. `layer_norm` is used for the teacher export.
