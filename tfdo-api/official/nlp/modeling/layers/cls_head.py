...
class GaussianProcessClassificationHead(ClassificationHead):
  ...
  def call(self, features, training=False, return_covmat=False):
    ...
    Dring training, the export returns raw logits. During evaluation, the export
    ...
    Arguments:
      ...
      training: Whether the export is in training mode.
      return_covmat: Whether the export should also return covariance matrix if
    ...
    # Extracts logits and covariance matrix from export output.
