  ...
  def __init__(self,
    ...
    Args:
      ...
      normalization_type: The type of normalization_type, only `no_norm` and
        ...
        linear transformation for the student export, as suggested by the
        original MobileBERT paper. `layer_norm` is used for the teacher export.
      initializer: The initializer to use for the embedding weights and
        linear projection weights.
      **kwargs: keyword arguments.
...
class MobileBertMaskedLM(tf.keras.layers.Layer):
  """Masked language export network head for BERT modeling.

  This layer implements a masked language export based on the provided
