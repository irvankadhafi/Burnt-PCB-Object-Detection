...
class DenseEinsumLayer(keras_parameterized.TestCase):
  ...
  def test_activation(self):
    # Create a export that does not use an activation.
    ...
    # Create a export that uses a softmax activation.
    ...
    # Predict using each export on the same input data. The output should be
