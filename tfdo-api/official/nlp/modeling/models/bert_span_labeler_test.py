...
class BertSpanLabelerTest(keras_parameterized.TestCase):
  ...
  def test_bert_trainer(self, dict_outputs):
    ...
    # Invoke the trainer export on the inputs. This causes the layer to be built.
  ...
  def test_bert_trainer_named_compilation(self):
    ...
    # Attempt to compile the export using a string-keyed dict of output names to
  ...
  def test_bert_trainer_tensor_call(self):
    ...
    # Invoke the trainer export on the tensors. In Eager mode, this does the
