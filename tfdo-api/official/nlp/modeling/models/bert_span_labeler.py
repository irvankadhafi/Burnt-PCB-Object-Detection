...
"""BERT Question Answering export."""
...
class BertSpanLabeler(tf.keras.Model):
  """Span labeler export based on a BERT-style transformer-based encoder.
  ...
  *Note* that the export is constructed by
  ...
  def __init__(self,
    ...
    # The input network (typically a transformer export) may get outputs from all
