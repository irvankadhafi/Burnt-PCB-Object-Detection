...
"""Run NHNet export training and eval."""
...
def define_flags():
  ...
  flags.DEFINE_string(
      "model_dir", None,
      "The output directory where the export checkpoints will be written.")
  ...
  flags.DEFINE_string(
      ...
      "Initial checkpoint (usually from a pre-trained BERT export).")
  ...
  flags.DEFINE_string("model_type", "nhnet",
                      "Model type to choose a export configuration.")
  flags.DEFINE_integer(
