...
def pretrain_model(bert_config,
  ...
  """Returns export to be used for pre-training.

  Args:
      bert_config: Configuration that defines the core BERT export.
  ...
  Returns:
      A Tuple of (1) Pretraining export, (2) core BERT submodel from which to
...
def squad_model(bert_config,
  ...
  """Returns BERT Squad export along with core BERT export to import weights.

  Args:
    bert_config: BertConfig, the config defines the core Bert export.
  ...
  Returns:
    A tuple of (1) keras export that outputs start logits and end logits and
...
def classifier_model(bert_config,
                     ...
                     hub_module_url=None,
                     hub_module_trainable=True):
  """BERT classifier export in functional API style.

  Construct a Keras export for predicting `num_labels` outputs from an input with
  ...
  Returns:
    Combined prediction export (words, mask, type) -> (one-hot labels)
    BERT sub-export (words, mask, type) -> (bert_outputs)
  """
