...
flags.DEFINE_enum(
    ...
    'trains the export and evaluates in the meantime. '
    '`export_only`: will take the latest checkpoint inside '
    'model_dir and export a `SavedModel`. `predict`: takes a checkpoint and '
    'restores the export to output predictions on the test set.')
...
def run_keras_compile_fit(model_dir,
                          ...
                          training_callbacks=True,
                          custom_callbacks=None):
  """Runs BERT classifier export using Keras compile/fit API."""
...
def get_predictions_and_labels(strategy,
                               ...
                               is_regression=False,
                               return_probs=False):
  """Obtains predictions of trained export on evaluation data.
  ...
  Args:
    ...
    trained_model: Trained export with preloaded weights.
...
def export_classifier(model_export_path, input_meta_data, bert_config,
                      model_dir):
  """Exports a trained export as a `SavedModel` for inference.

  Args:
    model_export_path: a string specifying the path to the SavedModel directory.
    input_meta_data: dictionary containing meta data about input and export.
    bert_config: Bert configuration file to define core bert layers.
    model_dir: The directory where the export weights and training/evaluation
