...
class BertModelsTest(tf.test.TestCase):
  ...
  def test_pretrain_model(self):
    ...
    # export has one scalar output: loss value.
  ...
  def test_squad_model(self):
    ...
    # Expect two output from export: start positions and end positions
  ...
  def test_classifier_model(self):
    ...
    # export has one classification output with num_labels=3.
