...
class DistillationTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def prepare_config(self, teacher_block_num, student_block_num,
    ...
    # using small export for testing
    ...
    # Create a teacher export checkpoint.
    ...
    # The export variables will be created after the forward call.
  ...
  def test_task(self, teacher_block_num, student_block_num,
    ...
    logging.info('begin to save and load export checkpoint')
