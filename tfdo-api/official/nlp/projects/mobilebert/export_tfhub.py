...
"""A script to export the MobileBERT encoder export as a TF-Hub SavedModel."""
...
flags.DEFINE_string("model_checkpoint_path", None,
                    "File path to TF export checkpoint.")
flags.DEFINE_string("export_path", None, "TF-Hub SavedModel destination path.")
flags.DEFINE_string("vocab_file", None,
                    "The vocabulary file that the BERT export was trained on.")
flags.DEFINE_bool("do_lower_case", True, "Whether to lowercase.")


def create_mobilebert_model(bert_config):
  """Creates a export for exporting to tfhub."""
...
def export_bert_tfhub(bert_config, model_checkpoint_path, hub_destination,
  ...
  logging.info("Begin to load export")
  checkpoint.restore(model_checkpoint_path).assert_existing_objects_matched()
  logging.info("Loading export finished")
