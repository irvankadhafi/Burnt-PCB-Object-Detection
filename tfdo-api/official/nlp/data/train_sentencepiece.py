...
"""A script to train sentencepiece export from tensorflow datasets.
...
flags.DEFINE_string("output_model_path", None,
                    "Path to save the the sentencepiece export.")
...
def train_sentencepiece(
  ...
  Args:
    ...
    model_path: path of export file to save vocab export to.
    vocab_size: size of vocab tokens to train.
    character_coverage: amount of characters covered by the export, good defaults
      are 0.9995 for languages with rich character set like Japanese or Chinese
      and 1.0 for other languages with small character set.
    model_type: type of sentencepiece vocab to train.

  Returns:
    path to the trained sentencepiece vocabulary export.
  """
  argstr = " ".join([
...
def main(argv: List[str]):
  ...
  logging.info("Sentencepiece export will be placed here: %s",
