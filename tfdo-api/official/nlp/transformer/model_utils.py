...
"""Transformer export helper methods."""
...
def get_position_encoding(length,
  ...
  """
  # We compute the positional encoding in float32 even if the export uses
...
def get_decoder_self_attention_bias(length, dtype=tf.float32):
  """Calculate bias for decoder that maintains export's autoregressive property.
