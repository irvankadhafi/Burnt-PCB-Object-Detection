...
"""Defines Transformer export parameters."""
...
# Parameters for running the export in multi gpu. These should not change the
# params that modify the export shape (such as the hidden_size or num_heads).
...
# Parameters for testing the export
