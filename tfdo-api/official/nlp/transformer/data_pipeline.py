...
"""Input pipeline for the transformer export to read, filter, and batch examples.
  ...
  Args:
    ...
    static_batch: Whether the batches in the dataset should have static shapes.
      ...
      shapes [N, M], where: N * M <= batch_size M <= max_length In general, this
        ...
        so that the number of padding tokens is minimized, and helps export
...
def map_data_for_transformer_fn(x, y):
  ...
  # Will transform input x and targets y into tuple(x, y) as new export inputs.
