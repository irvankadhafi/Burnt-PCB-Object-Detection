...
"""Functions for calculating loss, accuracy, and other export metrics.
...
def get_eval_metrics(logits, labels, params):
  """Return dictionary of export evaluation metrics."""
  metrics = {
...
def rouge_2_fscore(logits, labels):
  ...
  Args:
    logits: tensor, export predictions
...
def rouge_l_fscore(predictions, labels):
  ...
  Args:
    predictions: tensor, export predictions
    labels: tensor, gold output.
