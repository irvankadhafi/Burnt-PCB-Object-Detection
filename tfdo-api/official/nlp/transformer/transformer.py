...
"""Defines the Transformer export in TF 2.0.

Model paper: https://arxiv.org/pdf/1706.03762.pdf
Transformer export code source: https://github.com/tensorflow/tensor2tensor
"""
...
class Transformer(tf.keras.Model):
  """Transformer export with Keras.

  Implemented as described in: https://arxiv.org/pdf/1706.03762.pdf

  The Transformer export consists of an encoder and decoder. The input is an int
  ...
  def __init__(self, params, name=None):
    """Initialize layers to build Transformer export.
