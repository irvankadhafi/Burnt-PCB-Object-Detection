...
def define_transformer_flags():
  ...
  flags.DEFINE_enum(
      ...
      help=flags_core.help_wrap(
          'Parameter set to use when creating and training the export. The '
          'parameters define the input shape (batch size and max length), '
          'export configuration (size of embedding, # of hidden layers, etc.), '
          'and various other settings. The big parameter set increases the '
          'default batch size, embedding/hidden size, and filter size. For a '
          'complete list of parameters, please see export/model_params.py.'))
  ...
  flags.DEFINE_bool(
      ...
      help=flags_core.help_wrap(
          ...
          'minimized, and helps export training. In cases where the input shape '
  ...
  flags.DEFINE_bool(
      ...
      default=False,
      help=flags_core.help_wrap(
          'Whether the export runs with custom training loop.'))
  flags.DEFINE_integer(
  ...
  flags.DEFINE_bool(
      ...
      help=flags_core.help_wrap(
          ...
          'If True, then only the export\'s weights will be saved '
          '(`export.save_weights(filepath)`), else the full export is saved '
