...
"""Common flags used in XLNet export."""
...
flags.DEFINE_string(
    "init_checkpoint",
    default=None,
    help="Checkpoint path for initializing the export.")
flags.DEFINE_bool(
    "init_from_transformerxl",
    default=False,
    help="Init from a transformerxl export checkpoint. Otherwise, init from the "
    "entire export checkpoint.")
...
flags.DEFINE_integer("d_model", default=32, help="Dimension of the export.")
