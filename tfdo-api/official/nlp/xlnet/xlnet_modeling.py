...
"""Keras layers of XLNet export in TF 2.0."""
...
class PretrainingXLNetModel(tf.keras.Model):
  """XLNet keras export combined with pretraining LM loss layer.
...
class ClassificationXLNetModel(tf.keras.Model):
  """XLNet keras export combined with classification loss layer.
...
class LMLossLayer(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    Args:
      ...
      hidden_size: The dimension of export hidden state.
...
class Summarization(tf.keras.layers.Layer):
  """The layer to pool the output from XLNet export into a vector."""
  ...
  def __init__(self,
    ...
    Args:
      hidden_size: int, the dimension of export hidden state.
...
class QAXLNetModel(tf.keras.Model):
  """XLNet keras export combined with question answering loss layer.
