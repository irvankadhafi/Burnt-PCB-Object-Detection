...
class ExportModule(tf.Module, metaclass=abc.ABCMeta):
  ...
  def __init__(self,
    ...
    Args:
      ...
      model: A export instance which contains weights and forward computation.
      inference_step: An optional callable to define how the export is called.
    """
...
def export(export_module: ExportModule,
  ...
  Args:
    ...
    export_savedmodel_dir: Output saved export directory.
