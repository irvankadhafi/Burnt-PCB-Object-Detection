...
class Task(tf.Module, metaclass=abc.ABCMeta):
  ...
  def __init__(self,
    ...
    Args:
      ...
      logging_dir: a string pointing to where the export, summaries etc. will be
  ...
  def initialize(self, model: tf.keras.Model):
    ...
    This function will be called when no checkpoint is found for the export.
  ...
  def build_model(self) -> tf.keras.Model:
    """[Optional] Creates export architecture.
  ...
  def process_metrics(self, metrics, labels, model_outputs):
    ...
    Args:
      ...
      model_outputs: a tensor or a nested structure of tensors. For example,
        output of the keras export built by self.build_model.
    """
  ...
  def process_compiled_metrics(self, compiled_metrics, labels, model_outputs):
    ...
    Args:
      compiled_metrics: the compiled metrics (export.compiled_metrics).
      labels: a tensor or a nested structure of tensors.
      model_outputs: a tensor or a nested structure of tensors. For example,
        output of the keras export built by self.build_model.
    """
