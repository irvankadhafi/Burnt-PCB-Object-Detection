...
def get_inputs(params):
  """Returns some parameters used by the export."""
...
def define_ncf_flags():
  ...
  flags.DEFINE_integer(
      name="num_factors",
      default=8,
      help=flags_core.help_wrap("The Embedding size of MF export."))
  ...
  flags.DEFINE_bool(
      ...
      default=False,
      help=flags_core.help_wrap(
          "If set, changes the behavior of the export slightly to match the "
  ...
  flags.DEFINE_bool(
      ...
      help=flags_core.help_wrap(
          ...
          "if one is running the export for MLPerf. See "
...
def convert_to_softmax_logits(logits):
  """Convert the logits returned by the base export to softmax logits.
