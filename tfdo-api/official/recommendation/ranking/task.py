...
class RankingTask(base_task.Task):
  ...
  def build_model(self) -> tf.keras.Model:
    ...
    if self.task_config.model.interaction == 'dot':
      ...
      raise ValueError(
          f'params.task.export.interaction {self.task_config.model.interaction} '
