...
def define_base(data_dir=True,
  ...
  Args:
    ...
    model_dir: Create a flag for specifying the export file directory.
  ...
  if model_dir:
    flags.DEFINE_string(
        ...
        short_name="md",
        default="/tmp",
        help=help_wrap("The location of the export checkpoint files."))
  ...
  if run_eagerly:
    flags.DEFINE_boolean(
        name="run_eagerly",
        default=False,
        help="Run the export op by op without building a export function.")
  ...
  if export_dir:
    flags.DEFINE_string(
        ...
        short_name="ed",
        default=None,
        help=help_wrap("If set, a SavedModel serialization of the export will "
