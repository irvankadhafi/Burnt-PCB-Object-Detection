...
def define_common_hparams_flags():
  ...
  flags.DEFINE_string(
      'model_dir',
      default=None,
      help=('The directory where the export and training/evaluation summaries'
            'are stored.'))
  ...
  flags.DEFINE_string(
      ...
      help=('a YAML/JSON string or a YAML file which specifies additional '
            ...
            'override the export parameters, but not the parameters like TPU '
...
def hparam_flags_dict():
  """Returns export params related flags in a dictionary."""
  return {
