...
"""Build export for inference or training."""
...
class Model(object):
  ...
  def __init__(self,
    ...
    # At this point, the export is ready.  Print some info on export params.
  ...
  def build_depth_test_graph(self):
    """Builds depth export reading from placeholders."""
    with tf.name_scope('depth_prediction'):
      with tf.variable_scope('depth_prediction'):
        ...
        # TODO(rezama): Retrain published export with batchnorm params and set
  ...
  def build_egomotion_test_graph(self):
    """Builds egomotion export reading from placeholders."""
    input_uint8 = tf.placeholder(
        tf.uint8,
