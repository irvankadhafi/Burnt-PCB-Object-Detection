...
# Every training step feeds the export two points clouds A, B, such that
...
def run_training():
  """Train export for a number of steps."""
  # Tell TensorFlow that the export will be built into the default Graph.
