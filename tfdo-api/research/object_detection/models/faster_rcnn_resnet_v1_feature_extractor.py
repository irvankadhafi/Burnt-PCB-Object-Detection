...
to finetune this export is trained using the same configuration as that of
...
class FasterRCNNResnetV1FeatureExtractor(
  ...
  def __init__(self,
    ...
    Args:
      architecture: Architecture name of the Resnet V1 export.
      resnet_model: Definition of the Resnet V1 export.
      is_training: See base class.
      first_stage_features_stride: See base class.
      batch_norm_trainable: See base class.
      reuse_weights: See base class.
      weight_decay: See base class.
      activation_fn: Activaton functon to use in Resnet V1 export.
