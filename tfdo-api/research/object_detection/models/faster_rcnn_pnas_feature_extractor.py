...
Based on PNASNet export: https://arxiv.org/abs/1712.00559
"""
...
# a sub-network from the original PNASNet export, starting from the
...
def _build_pnasnet_base(
    ...
    start_cell_num):
  """Constructs a PNASNet image export for proposal classifier features."""
