...
class _LayersOverride(object):
  ...
  def __init__(self,
    ...
    - Adds support for feature map alignment (like in the Slim export)
    - Adds support for changing the output stride (like in the Slim export)
  ...
  def Conv2D(self, filters, kernel_size, **kwargs):
    ...
    # layers in the export according to their filter count, name, or
