...
class _LayersOverride(object):
  ...
  def Conv2D(self, filters, kernel_size, **kwargs):  # pylint: disable=invalid-name
    ...
    # Set use_bias as false to keep it consistent with Slim Resnet export.
...
def resnet_v1_50(batchnorm_training,
  ...
  Returns:
    A Keras ResnetV1-50 export instance.
  """
...
def resnet_v1_101(batchnorm_training,
  ...
  Returns:
    A Keras ResnetV1-101 export instance.
  """
  layers_override = _LayersOverride(
      batchnorm_training,
      batchnorm_scale=batchnorm_scale,
...
def resnet_v1_152(batchnorm_training,
  ...
  Returns:
    A Keras ResnetV1-152 export instance.
  """
  layers_override = _LayersOverride(
      batchnorm_training,
      batchnorm_scale=batchnorm_scale,
...
# The following codes are based on the existing keras ResNet export pattern:
