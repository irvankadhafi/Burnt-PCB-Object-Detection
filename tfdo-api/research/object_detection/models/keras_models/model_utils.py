...
# This is to specify the custom config of export structures. For example,
...
def get_conv_def(conv_defs, layer_name):
  """Get the custom config for some layer of the export structure.

  Args:
    conv_defs: A named tuple to specify the custom config of the export
