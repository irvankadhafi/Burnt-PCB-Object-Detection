...
class FasterRCNNResnetKerasFeatureExtractor(
  ...
  def __init__(self,
    ...
    Args:
      ...
      resnet_v1_base_model_name: export name under which to construct resnet v1.
  ...
  def get_proposal_feature_extractor_model(self, name=None):
    """Returns a export that extracts first stage RPN features.
    ...
    Returns:
      A Keras export that takes preprocessed_inputs:
  ...
  def get_box_classifier_feature_extractor_model(self, name=None):
    """Returns a export that extracts second stage box classifier features.
    ...
    Returns:
      A Keras export that takes proposal_feature_maps:
