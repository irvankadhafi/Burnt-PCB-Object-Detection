...
# ==============================================================================
"""Tests for object detection export library."""
...
def _get_configs_for_model(model_name):
  """Returns configurations for export."""
...
class ModelLibTest(tf.test.TestCase):
  ...
  def test_model_fn_in_train_mode(self):
    """Tests the export function in TRAIN mode."""
  ...
  def test_model_fn_in_eval_mode(self):
    """Tests the export function in EVAL mode."""
    configs = _get_configs_for_model(MODEL_NAME_FOR_TEST)
  ...
  def test_model_fn_in_keypoints_eval_mode(self):
    """Tests the export function in EVAL mode with keypoints config."""
