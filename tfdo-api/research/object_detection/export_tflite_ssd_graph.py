...
# ==============================================================================
r"""Exports an SSD detection export to use with tf-lite.
...
In floating point Mobilenet export, 'normalized_image_tensor' has values
...
In quantized Mobilenet export, 'normalized_image_tensor' has values between [0,
255].
