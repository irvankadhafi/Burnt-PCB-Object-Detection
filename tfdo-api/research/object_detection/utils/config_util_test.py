...
class ConfigUtilTest(tf.test.TestCase):
  ...
  def test_get_configs_from_pipeline_file(self):
    ...
    self.assertProtoEquals(pipeline_config.model, configs["export"])
  ...
  def test_get_configs_from_multiple_files(self):
    ...
    model_config_path = os.path.join(temp_dir, "export.config")
    ...
    self.assertProtoEquals(model, configs["export"])
  ...
  def testGenericConfigOverride(self):
    ...
    self.assertEqual(2, configs["export"].ssd.num_classes)
  ...
  def testNewFocalLossParameters(self):
    ...
    configs = config_util.get_configs_from_pipeline_file(pipeline_config_path)
    configs = config_util.merge_external_params_with_configs(configs, hparams)
    classification_loss = configs["export"].ssd.loss.classification_loss
  ...
  def testGetNumberOfClasses(self):
    ...
    configs = config_util.get_configs_from_pipeline_file(pipeline_config_path)
    number_of_classes = config_util.get_number_of_classes(configs["export"])
  ...
  def testUpdateNumClasses(self):
    ...
    self.assertEqual(config_util.get_number_of_classes(configs["export"]), 10)

    config_util.merge_external_params_with_configs(
        configs, kwargs_dict={"num_classes": 2})

    self.assertEqual(config_util.get_number_of_classes(configs["export"]), 2)
  ...
  def testUpdateRescoreInstances(self):
    ...
    configs = config_util.get_configs_from_pipeline_file(pipeline_config_path)
    cn_config = configs["export"].center_net
    self.assertEqual(
