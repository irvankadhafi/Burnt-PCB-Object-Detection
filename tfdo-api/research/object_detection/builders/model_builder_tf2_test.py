...
class ModelBuilderTF2Test(
  ...
  def test_create_center_net_model(self, customize_head_params):
    """Test building a CenterNet export from proto txt."""
    proto_txt = """
      center_net {
        num_classes: 10
        feature_extractor {
    ...
    # Build the export from the configuration.
  ...
  def test_create_center_net_model_mobilenet(self):
    """Test building a CenterNet export using bilinear interpolation."""
    proto_txt = """
      center_net {
        num_classes: 10
        feature_extractor {
  ...
  def test_create_center_net_deepmac(self):
    """Test building a CenterNet DeepMAC export."""
