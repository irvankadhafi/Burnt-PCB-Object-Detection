...
# ==============================================================================
r"""Creates and runs `Estimator` for object detection export on TPUs.

This uses the TPUEstimator API to define and run a export in TRAIN/EVAL modes.
"""
...
flags.DEFINE_string(
    'model_dir', None, 'Path to output export directory '
