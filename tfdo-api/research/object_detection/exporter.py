...
def write_saved_model(saved_model_path,
  ...
  eliminating the need of checkpoint files during inference. If the export
...
def _export_inference_graph(input_type,
  ...
  model_path = os.path.join(output_directory, 'export.ckpt')
...
def export_inference_graph(input_type,
                           ...
                           side_input_names=None,
                           side_input_types=None):
  """Exports inference graph for the export specified in the pipeline config.
  ...
  Args:
    ...
    use_side_inputs: If True, the export requires side_inputs.
...
def profile_inference_graph(graph):
  ...
  Prints export parameters and computation FLOPs given an inference graph.
