...
# ==============================================================================
"""Model input function for tf-learn object detection export."""
...
def transform_input_data(tensor_dict,
  ...
  4. keypoint_type_weight (optional): If groundtruth keypoints are in
     ...
     avoid penalizing the export in a loss function).
  ...
  Args:
    ...
    model_preprocess_fn: export's preprocess function to apply on image tensor.
  ...
  # Apply export preprocessing ops and resize instance masks.
...
def pad_input_data_to_static_shapes(tensor_dict,
  ...
  if input_fields.context_features in tensor_dict and (
    ...
    raise ValueError('max_num_context_features must be specified in the export '
...
def eval_input(eval_config, eval_input_config, model_config,
  ...
  if eval_config.force_no_resize:
    arch = model_config.WhichOneof('export')
