...
class SSDKerasFeatureExtractor(tf.keras.Model):
  ...
  def __init__(self,
    ...
    Args:
      ...
      name: A string name scope to assign to the export. If 'None', Keras
  ...
  def __init__(self,
    ...
    Args:
      ...
      add_background_class: Whether to add an implicit background class to
        ...
        single class export or using groundtruth labels with an explicit
        background class.
      ...
      random_example_sampler: a BalancedPositiveNegativeSampler object that can
        ...
        example miner can both be applied to the export. In that case, random
