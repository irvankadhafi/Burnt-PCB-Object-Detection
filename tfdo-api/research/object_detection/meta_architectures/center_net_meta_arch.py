...
class CenterNetFeatureExtractor(tf.keras.Model):
  ...
  def __init__(self, name=None, channel_means=(0., 0., 0.),
    ...
    Args:
      name: str, the name used for the underlying keras export.
  ...
  def preprocess(self, inputs):
    """Converts a batch of unscaled images to a scale suitable for the export.
...
def prediction_to_single_instance_keypoints(
  ...
  the image, the export prefers to predict the one that is closest to the image
...
def _pad_to_full_keypoint_dim(keypoint_coords, keypoint_scores, keypoint_inds,
  ...
  Args:
    ...
    num_total_keypoints: The total number of keypoints that this export predicts.
...
def _pad_to_full_instance_dim(keypoint_coords, keypoint_scores, instance_inds,
  ...
  Args:
    ...
    max_instances: The maximum number of instances detected by the export.
...
def row_col_channel_indices_from_flattened_indices(indices, num_cols,
  ...
  """
  # Be careful with this function when running a export in float16 precision
...
def convert_strided_predictions_to_normalized_boxes(boxes, stride,
  ...
  Args:
    boxes: A tensor of shape [batch_size, num_boxes, 4] holding the raw
     coordinates of boxes in the export's output space.
...
def convert_strided_predictions_to_normalized_keypoints(
  ...
  Args:
    keypoint_coords: A tensor of shape
      ...
      of keypoints in the export's output space.
  ...
  def __new__(cls,
    ...
    Args:
      ...
      predict_depth: A bool indicates whether to predict the depth of each
        keypoints.
      per_keypoint_depth: A bool indicates whether the export predicts the depth
...
class CenterNetMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    """Initializes a CenterNet export.

    Args:
      is_training: Set to True if this export is being built for training.
      add_summaries: Whether to add tf summaries in the export.
      num_classes: int, The number of classes that the export should predict.
  ...
  def _compute_box_scale_and_offset_loss(self, input_height, input_width,
    ...
    Args:
      ...
      scale_predictions: A list of float tensors of shape [batch_size,
        out_height, out_width, 2] representing the prediction heads of the export
  ...
  def _compute_kp_heatmap_loss(self, input_height, input_width, task_name,
    ...
    Args:
      ...
      heatmap_predictions: A list of float tensors of shape [batch_size,
        ...
        of the export for keypoint heatmap.
  ...
  def _compute_kp_regression_loss(self, input_height, input_width, task_name,
    ...
    Args:
      ...
      regression_predictions: A list of float tensors of shape [batch_size,
        ...
        heads of the export for keypoint regression offset.
      localization_loss_fn: An object_detection.core.losses.Loss object to
  ...
  def _compute_kp_depth_loss(self, input_height, input_width, task_name,
    ...
    Args:
      ...
      depth_predictions: A list of float tensors of shape [batch_size,
        ...
        heads of the export for keypoint depth.
      localization_loss_fn: An object_detection.core.losses.Loss object to
        compute the loss for the keypoint offset predictions in CenterNet.
  ...
  def _rescore_instances(self, classes, scores, keypoint_scores):
    ...
    # tflite that will cause the export to run slower at inference.
  ...
  def postprocess(self, prediction_dict, true_image_shapes, **params):
    ...
    if self._kp_params_dict:
      # If the export is trained to predict only one class of object and its
  ...
  def postprocess_single_instance_keypoints(
    ...
    Here is a short list of the modifications made in this function:
      ...
      1) Assume the export predicts only single class keypoint.
      2) Assume there is only one instance in the image. If multiple instances
         appear in the image, the export tends to predict the one that is closer
         to the image center (the other ones are considered as background and
         are rejected by the export).
  ...
  def _postprocess_keypoints_multi_class(self, prediction_dict, classes,
    ...
    _postprocess_keypoints_single_class if you plan to export the export in more
    portable format.
  ...
  def _postprocess_keypoints_single_class(self, prediction_dict, classes,
    ...
    This function handles the special case of keypoint task that the export
  ...
  def restore_from_objects(self, fine_tune_checkpoint_type='detection'):
    ...
    or Checkpoint). This enables the export to initialize based on weights from
    another task. For example, the feature extractor variables from a
    classification export can be used to bootstrap training of an object
    detector. When loading from an object detection export, the checkpoint export
    should have the same parameters as this detection export with exception of
    ...
    Args:
      fine_tune_checkpoint_type: whether to restore from a full detection
        ...
        'fine_tune': used when loading the entire CenterNet feature extractor
          ...
          export training can be directly loaded using this type. With this
          checkpoint type, the weights of the feature extractor are expected
          under the attribute 'export._feature_extractor'.
    ...
    if fine_tune_checkpoint_type == 'detection':
      ...
      return {'export': feature_extractor_model}
  ...
  def updates(self):
    if tf_version.is_tf2():
      raise RuntimeError('This export is intended to be used with model_lib_v2 '
