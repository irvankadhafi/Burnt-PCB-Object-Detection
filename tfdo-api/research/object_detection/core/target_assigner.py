...
class CenterNetCenterHeatmapTargetAssigner(object):
  ...
  def assign_center_targets_from_boxes(self,
    ...
    Args:
      height: int, height of input to the export. This is used to
        determine the height of the output.
      width: int, width of the input to the export. This is used to
...
class CenterNetBoxTargetAssigner(object):
  ...
  def assign_size_and_offset_targets(self,
    ...
    Args:
      height: int, height of input to the export. This is used to determine the
        height of the output.
      width: int, width of the input to the export. This is used to determine the
        width of the output.
      gt_boxes_list: A list of float tensors with shape [num_boxes, 4]
        representing the groundtruth detection bounding boxes for each sample in
...
class CenterNetKeypointTargetAssigner(object):
  ...
  CenterNet export for keypoint estimation. Specifically, the class methods
  ...
  def assign_keypoint_heatmap_targets(self,
                                      ...
                                      gt_weights_list=None,
                                      gt_boxes_list=None):
    """Returns the keypoint heatmap targets for the CenterNet export.

    Args:
      height: int, height of input to the CenterNet export. This is used to
        determine the height of the output.
      width: int, width of the input to the CenterNet export. This is used to
        determine the width of the output.
...
class CenterNetTemporalOffsetTargetAssigner(object):
  ...
  def assign_temporal_offset_targets(self,
    ...
    temporal offset to train the export.
