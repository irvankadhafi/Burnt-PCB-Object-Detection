...
Example Usage 2 (export CenterNet export for keypoint estimation task with fixed
...
flags.DEFINE_bool(
    ...
    'Whether to export the predicted keypoint tensors. Only CenterNet export'
    ' supports this flag.'
)
flags.DEFINE_string(
    ...
    ' this one. Note that it is only used when exporting CenterNet export for'
