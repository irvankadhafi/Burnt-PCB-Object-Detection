...
"""A multi-task and semi-supervised NLP export."""
...
from export import encoder
from export import shared_inputs
...
class Model(object):
  def __init__(self, config, pretrained_embeddings, tasks):
    ...
    with tf.variable_scope('export', reuse=tf.AUTO_REUSE) as scope:
      ...
      if config.ema_test or config.ema_teacher:
        ...
        model_vars = tf.get_collection("trainable_variables", "export")
