...
# ==============================================================================
"""Export DELG tensorflow inference export.

The exported export can be used to jointly extract local and global features. It
...
flags.DEFINE_boolean(
    ...
    'Whether the exported export should use an autoencoder.')
flags.DEFINE_float(
...
class _ExtractModule(tf.Module):
  """Helper module to build and save DELG export."""
  ...
  def __init__(self,
    ...
    # Setup the DELG export for extraction.
