...
# ==============================================================================
"""DELF export implementation based on the following paper.
...
class AttentionModel(tf.keras.Model):
  ...
  def __init__(self, kernel_size=1, decay=_DECAY, name='attention'):
    """Initialization of attention export.
...
class AutoencoderModel(tf.keras.Model):
  """Instantiates the Keras Autoencoder export."""

  def __init__(self, reduced_dimension, expand_dimension, kernel_size=1,
               name='autoencoder'):
    """Initialization of Autoencoder export.
...
class Delf(tf.keras.Model):
  """Instantiates Keras DELF export using ResNet50 as backbone.

  This class implements the [DELF](https://arxiv.org/abs/1612.06321) export for
