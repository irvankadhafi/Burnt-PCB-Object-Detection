...
# ==============================================================================
"""Export DELF tensorflow inference export.

The exported export may use an image pyramid for multi-scale processing, with
...
class _ExtractModule(tf.Module):
  """Helper module to build and save DELF export."""
