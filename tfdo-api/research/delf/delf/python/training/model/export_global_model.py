...
# ==============================================================================
"""Export global feature tensorflow inference export.

The exported export may leverage image pyramids for multi-scale processing.
"""
...
flags.DEFINE_boolean('delg_global_features', False,
                     'Whether the export uses a DELG-like global feature head.')
flags.DEFINE_float(
    'delg_gem_power', 3.0,
...
class _ExtractModule(tf.Module):
  """Helper module to build and save global feature export."""
  ...
  def __init__(self,
               ...
               delg_gem_power=3.0,
               delg_embedding_layer_dim=2048):
    """Initialization of global feature export.
    ...
    Args:
      ...
      input_scales_tensor: If None, the exported function to be used should be
        ...
        the exported export. If not None, the specified 1D tensor of floats will
        be hard-coded as the desired input scales, in conjunction with
        ExtractFeaturesFixedScales.
      delg_global_features: Whether the export uses a DELG-like global feature
        head.
      delg_gem_power: Power for Generalized Mean pooling in the DELG export. Used
    ...
    # Setup the DELF export for extraction.
