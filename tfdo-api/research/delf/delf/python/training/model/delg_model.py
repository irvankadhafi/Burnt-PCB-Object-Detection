...
# ==============================================================================
"""DELG export implementation based on the following paper.
...
class Delg(delf_model.Delf):
  """Instantiates Keras DELG export using ResNet50 as backbone.

  This class implements the [DELG](https://arxiv.org/abs/2001.05027) export for
  extracting local and global features from images. The same attention layer
  is trained as in the DELF export. In addition, the extraction of global
  ...
  def __init__(self,
    ...
    Args:
      ...
      name: str, name to identify export.
    ...
    """
    logging.info('Creating Delg export, gem_power %d, embedding_layer_dim %d',
  ...
  def _create_backbone_classifier(self, num_classes):
    """Define the classifier for training the backbone export."""
