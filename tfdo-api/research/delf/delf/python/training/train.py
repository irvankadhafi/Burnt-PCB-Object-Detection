...
flags.DEFINE_float(
    ...
    'total loss of the export.')
flags.DEFINE_boolean('delg_global_features', False,
                     'Whether to train a DELG export.')
flags.DEFINE_float(
...
flags.DEFINE_float(
    ...
    'calculating total loss of the export. Used only if use_autoencoder=True.')
flags.DEFINE_float(
...
def create_model(num_classes):
  """Define DELF export, and initialize classifiers."""
...
def main(argv):
  ...
  with strategy.scope():
    ...
    # ------------------------------------------------------------
    # Setup DELF export and optimizer.
    ...
    def train_step(inputs):
      ...
      # Scaling factor summary for cosine logits for a DELG export.
      if FLAGS.delg_global_features:
        tf.summary.scalar(
