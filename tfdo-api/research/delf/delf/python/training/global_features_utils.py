...
# ==============================================================================
"""Utilities for the global export training."""
...
def get_standard_keras_models():
  """Gets the standard keras export names.
...
def create_model_directory(training_dataset, arch, pool, whitening, pretrained,
  ...
  """Based on the export parameters, creates the export directory.

  If the export directory does not exist, the directory is created.

  Args:
    training_dataset: String, training dataset name.
    arch: String, export architecture.
    pool: String, pooling option.
    whitening: Bool, whether the export is trained with global whitening.
    pretrained: Bool, whether the export is initialized with the precomputed
      weights.
    ...
    update_every: Integer, frequency of the export weights update.
  ...
  Returns:
    folder: String, path to the export folder.
  """
