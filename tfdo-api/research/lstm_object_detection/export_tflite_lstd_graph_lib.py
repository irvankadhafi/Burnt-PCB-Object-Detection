...
def append_postprocessing_op(frozen_graph_def,
  ...
  Args:
    frozen_graph_def: Frozen GraphDef for SSD export after freezing the
      checkpoint
...
def export_tflite_graph(pipeline_config,
  ...
  """Exports a tflite compatible graph and anchors for ssd detection export.

  Anchors are written to a tensor and tflite compatible graph
  is written to output_dir/tflite_graph.pb.

  Args:
    pipeline_config: Dictionary of configuration objects. Keys are `export`,
    ...
    trained_checkpoint_prefix: a file prefix for the checkpoint containing the
      trained parameters of the SSD export.
