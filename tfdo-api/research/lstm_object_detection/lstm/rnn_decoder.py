...
def rnn_decoder(decoder_inputs,
                ...
                loop_function=None,
                scope=None):
  """RNN decoder for the LSTM-SSD export.
...
def multi_input_rnn_decoder(decoder_inputs,
                            ...
                            flatten_state=False,
                            scope=None):
  """RNN decoder for the Interleaved LSTM-SSD export.
...
def select_state(previous_state, new_state, action):
  ...
  generated from the large export, and thus we will update the state. Otherwise,
  if the action is 1, it means the state is generated from the small export, and
  in interleaved export, we skip this state update.
