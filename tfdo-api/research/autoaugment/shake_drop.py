...
def bottleneck_layer(x, n, stride, prob, is_training, alpha, beta):
  """Bottleneck layer for shake drop export."""
...
def build_shake_drop_model(images, num_classes, is_training):
  """Builds the PyramidNet Shake-Drop export.

  Build the PyramidNet Shake-Drop export from https://arxiv.org/abs/1802.02375.
  ...
  Returns:
    The logits of the PyramidNet Shake-Drop export.
  """
  # ShakeDrop Hparams
  p_l = 0.5
  alpha_shake = [-1, 1]
