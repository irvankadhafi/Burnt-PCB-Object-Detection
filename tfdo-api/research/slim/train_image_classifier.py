...
# ==============================================================================
"""Generic training script that trains a export using a given dataset."""
...
tf.app.flags.DEFINE_integer('num_clones', 1,
                            'Number of export clones to deploy. Note For '
...
tf.app.flags.DEFINE_integer(
    ...
    'The frequency with which the export is saved, in seconds.')
...
tf.app.flags.DEFINE_float(
    'weight_decay', 0.00004, 'The weight decay on the export weights.')
...
def _get_init_fn():
  ...
  Note that the init_fn is only run when initializing the export during the very
  first global step.
