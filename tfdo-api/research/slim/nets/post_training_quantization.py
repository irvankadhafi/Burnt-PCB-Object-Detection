...
# ==============================================================================
"""Export quantized tflite export from a trained checkpoint."""
...
flags.DEFINE_boolean(
    ...
    "When true, uses the preprocessing corresponding to the export as specified "
...
flags.DEFINE_integer("num_classes", 1001,
                     "Number of output classes for the export.")
...
def main(_):
  ...
  print("tflite export written to %s" % FLAGS.output_tflite)
