...
# ==============================================================================
"""Contains a variant of the CIFAR-10 export definition."""
...
def cifarnet(images, num_classes=10, is_training=False,
             ...
             scope='CifarNet'):
  """Creates a variant of the CifarNet export.
  ...
  Args:
    ...
    num_classes: the number of classes in the dataset. If 0 or None, the logits
      ...
      instead.
    is_training: specifies whether or not we're currently training the export.
...
def cifarnet_arg_scope(weight_decay=0.004):
  ...
  Returns:
    An `arg_scope` to use for the inception v3 export.
  """
  with slim.arg_scope(
      [slim.conv2d],
