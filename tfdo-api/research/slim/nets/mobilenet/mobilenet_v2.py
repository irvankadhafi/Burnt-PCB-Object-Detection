...
The base export gives 72.2% accuracy on ImageNet, with 300MMadds,
3.4 M parameters.
"""
...
def mobilenet(input_tensor,
  ...
  Args:
    ...
    finegrain_classification_mode: When set to True, the export
...
def training_scope(**kwargs):
  ...
  Returns:
    An `arg_scope` to use for the mobilenet v2 export.
  """
