...
def pnasnet_large_arg_scope(weight_decay=4e-5, batch_norm_decay=0.9997,
  ...
  """Default arg scope for the PNASNet Large ImageNet export."""
...
def pnasnet_mobile_arg_scope(weight_decay=4e-5,
                             ...
                             batch_norm_epsilon=0.001):
  """Default arg scope for the PNASNet Mobile ImageNet export."""
...
def _build_pnasnet_base(images,
                        ...
                        is_training,
                        final_endpoint=None):
  """Constructs a PNASNet image export."""
...
def build_pnasnet_large(images,
                        ...
                        final_endpoint=None,
                        config=None):
  """Build PNASNet Large export for the ImageNet Dataset."""
...
def build_pnasnet_mobile(images,
                         ...
                         final_endpoint=None,
                         config=None):
  """Build PNASNet Mobile export for the ImageNet Dataset."""
...
class PNasNetNormalCell(nasnet_utils.NasNetABaseCell):
  ...
  def __init__(self, num_conv_filters, drop_path_keep_prob, total_num_cells,
    ...
    # Configuration for the PNASNet-5 export.
    operations = [
