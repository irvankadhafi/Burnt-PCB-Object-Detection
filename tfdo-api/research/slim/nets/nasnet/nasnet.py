...
# Notes for training large NASNet export on ImageNet
# -------------------------------------
...
# Notes for training the mobile NASNet ImageNet export
# -------------------------------------
...
def nasnet_cifar_arg_scope(weight_decay=5e-4,
  ...
  """Defines the default arg scope for the NASNet-A Cifar export.
...
def nasnet_mobile_arg_scope(weight_decay=4e-5,
  ...
  """Defines the default arg scope for the NASNet-A Mobile ImageNet export.
...
def nasnet_large_arg_scope(weight_decay=5e-5,
                           batch_norm_decay=0.9997,
                           batch_norm_epsilon=1e-3):
  """Defines the default arg scope for the NASNet-A Large ImageNet export.
...
def build_nasnet_cifar(images, num_classes,
                       ...
                       config=None,
                       current_step=None):
  """Build NASNet export for the Cifar Dataset."""
...
def build_nasnet_mobile(images, num_classes,
                        ...
                        config=None,
                        current_step=None):
  """Build NASNet Mobile export for the ImageNet Dataset."""
...
def build_nasnet_large(images, num_classes,
                       ...
                       config=None,
                       current_step=None):
  """Build NASNet Large export for the ImageNet Dataset."""
...
def _build_nasnet_base(images,
                       ...
                       final_endpoint=None,
                       current_step=None):
  """Constructs a NASNet image export."""
