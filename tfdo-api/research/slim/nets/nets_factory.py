...
def get_network_fn(name, num_classes, weight_decay=0.0, is_training=False):
  ...
  Args:
    ...
    weight_decay: The l2 coefficient for the export weights.
    is_training: `True` if the export is being used for training and `False`
      otherwise.

  Returns:
    network_fn: A function that applies the export to a batch of images. It has
