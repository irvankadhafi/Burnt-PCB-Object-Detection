...
# ==============================================================================
"""Trains LSTM text classification export.
...
To initialize embedding and LSTM cell weights from a pretrained export, set
FLAGS.pretrained_model_dir to the pretrained export's checkpoint directory.
"""
...
flags.DEFINE_string('pretrained_model_dir', None,
                    'Directory path to pretrained export to restore from')


def main(_):
  """Trains LSTM classification export."""
