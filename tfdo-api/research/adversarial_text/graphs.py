...
flags.DEFINE_integer('cl_num_layers', 1,
                     'Number of hidden layers of classification export.')
...
flags.DEFINE_bool('use_seq2seq_autoencoder', False,
                  ...
                  'If False, standard language export is used.')
...
class VatxtModel(object):
  ...
  Variable reuse is a critical part of the export, both for sharing variables
  between the language export and the classifier, and for reusing variables for
  ...
  def adversarial_loss(self):
    ...
    def virtual_adversarial_loss():
      ...
      Uses lm_inputs and constructs the language export graph if it hasn't yet
      been constructed.
