...
Constructs 3 datasets:
  1. Labeled data for the LSTM classification export, optionally with label gain.
     "*_classification.tfrecords" (for both unidirectional and bidirectional
     models).
  2. Data for the unsupervised LM-LSTM export that predicts the next token.
     "*_lm.tfrecords" (generates forward and reverse data).
  3. Data for the unsupervised SA-LSTM export that uses Seq2Seq.
     "*_sa.tfrecords".
"""
