...
# ==============================================================================
"""Script to train langid export.

The script builds language detection from wikipedia dataset,
builds SGNN export to train an on-device export to
...
def save_and_convert(model, output_dir):
  """Save keras export and convert to tflite."""
  ...
  with open(os.path.join(output_dir, 'export.tflite'), 'wb') as f:
    f.write(data)


def train_and_evaluate():
  """Train and evaluate the export."""
