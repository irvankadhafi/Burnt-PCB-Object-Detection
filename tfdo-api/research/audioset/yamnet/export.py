"""Exports YAMNet as: TF2 SavedModel, TF-Lite export, TF-JS export.
...
map is available as the 'class_map_path()' method of the restored export.
...
def make_tflite_export(weights_path, export_dir):
  ...
  # Make a TF-Lite export from the SavedModel.
  log('Making TF-Lite export ...')
...
def make_tfjs_export(tflite_saved_model_dir, export_dir):
  ...
  # Make a TF-JS export from the TF-Lite SavedModel export.
  log('Making TF-JS export ...')
