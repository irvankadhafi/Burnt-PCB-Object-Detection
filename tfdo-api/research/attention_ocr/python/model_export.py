...
python model_export.py \
  --logtostderr --checkpoint=export.ckpt-399731 \
...
flags.DEFINE_string('export_dir', None, 'Directory to export export files to.')
...
flags.DEFINE_integer('version_number', 1, 'Version number of the export')
flags.DEFINE_bool(
    'export_for_serving', True,
    'Whether the exported export accepts serialized tf.Example '
    'protos as input')
...
def export_model(export_dir,
  ...
  Returns:
    Returns the export signature_def.
  """
  # Dataset object used only to get all parameters for the export.
