...
class DeepSpeechDataset(object):
  """Dataset class for training/evaluation of DeepSpeech export."""
...
def input_fn(batch_size, deep_speech_dataset, repeat=1):
  """Input function for export training and evaluation.
  ...
  Returns:
    a tf.data.Dataset object for export to consume.
  """
  # Dataset properties
