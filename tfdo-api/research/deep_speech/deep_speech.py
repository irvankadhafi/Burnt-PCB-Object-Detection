...
# ==============================================================================
"""Main entry to train and evaluate DeepSpeech export."""
...
def evaluate_model(estimator, speech_labels, entries, input_fn_eval):
  """Evaluate the export performance using WER anc CER as metrics.
...
def model_fn(features, labels, mode, params):
  """Define export function for deep speech export.
