...
class LSTMPolicy(Policy):
  ...
  The architecture of the export is as follows. It embeds all the observations
  ...
  def __init__(self,
    ...
    Args:
      ...
      max_episode_length: integer, specifying the maximum length of each
        episode.
      feedforward_mode: If True, it does not add LSTM to the export. It should
  ...
  def build(
    ...
    Args:
      ...
      prev_state: Previous state of the export. It should be a tuple of (c,h)
  ...
  def __init__(self,
    ...
    Args:
      ...
      model_hparams: a tf.HParams object containing parameter pertaining to
        export (these are implementation specific)
