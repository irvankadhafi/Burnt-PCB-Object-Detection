...
class Embedder(object):
  ...
  def build(self, observation):
    """Builds the export to embed the observation modality.
...
class DetectionBoxEmbedder(Embedder):
  """Represents the export that encodes the detection boxes from images."""
  ...
  def build(self, observations):
    """Builds the export to embed object detection observations.
