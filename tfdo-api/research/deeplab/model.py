...
# ==============================================================================
r"""Provides DeepLab export definition and helper functions.
...
def _decoder_with_sum_merge(decoder_features_list,
  ...
  Args:
    ...
    weight_decay: Weight decay for the export variables.
...
def get_branch_logits(features,
                      ...
                      reuse=None,
                      scope_suffix=''):
  """Gets the logits from each export's branch.

  The underlying export is branched out in the last layer when atrous
  ...
  Args:
    ...
    weight_decay: Weight decay for the export variables.
    reuse: Reuse export variables or not.
    scope_suffix: Scope suffix for the export variables.
