...
class Dataset(object):
  """Represents input dataset for deeplab export."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      model_variant: Model variant (string) for choosing how to mean-subtract
        the images. See feature_extractor.network_map for supported export
        variants.
    ...
    if model_variant is None:
      tf.logging.warning('Please specify a model_variant. See '
                         'feature_extractor.network_map for supported export '
                         'variants.')
