...
# ==============================================================================
"""Tools to convert a quantized deeplab export to tflite."""
...
flags.DEFINE_string('output_tflite_path', None, 'Output TFlite export path.')
flags.DEFINE_string(
    'input_tensor_name', None,
    'Input tensor to TFlite export. This usually should be the input tensor to '
    'export backbone.'
)
flags.DEFINE_string(
    'output_tensor_name', 'ArgMax:0',
    'Output tensor name of TFlite export. By default we output the raw semantic '
    'label predictions.'
)
flags.DEFINE_string(
    'test_image_path', None,
    'Path to an image to test the consistency between input graphdef / '
    'converted tflite export.'
)
...
def convert_to_tflite(quantized_graphdef,
                      ...
                      output_tensor):
  """Helper method to convert quantized deeplab export to TFlite."""
...
def check_tflite_consistency(graph_def, tflite_model, image_path):
  ...
  # Load tflite export and check input size.
