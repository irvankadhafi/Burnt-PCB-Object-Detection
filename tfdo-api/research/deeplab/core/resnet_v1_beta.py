...
def root_block_fn_for_beta_variant(net, depth_multiplier=1.0):
  ...
  Args:
    net: A tensor of size [batch, height, width, channels], input to the export.
...
def resnet_v1_beta(inputs,
  ...
  See the resnet_v1_*() methods for specific export instantiations, obtained by
