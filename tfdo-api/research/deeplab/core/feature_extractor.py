...
def _mobilenet_v2(net,
  ...
  Args:
    ...
    depth_multiplier: Float multiplier for the depth (number of channels)
      ...
      parameters or computation cost of the export.
...
def mobilenet_v3_large_seg(net,
                           ...
                           scope=None,
                           final_endpoint=None):
  """Final mobilenet v3 large export for segmentation task."""
  del divisible_by
  del final_endpoint
...
def mobilenet_edgetpu(net,
                      ...
                      scope=None,
                      final_endpoint=None):
  """EdgeTPU version of mobilenet export for segmentation task."""
  del divisible_by
  del final_endpoint
...
def mobilenet_v3_small_seg(net,
                           ...
                           scope=None,
                           final_endpoint=None):
  """Final mobilenet v3 small export for segmentation task."""
  del divisible_by
  del final_endpoint
...
def mobilenet_v2_arg_scope(is_training=True,
  ...
  Args:
    is_training: Whether or not we're training the export. If this is set to None
    ...
    weight_decay: The weight decay to use for regularizing the export.
  ...
  Returns:
    An `arg_scope` to use for the mobilenet v1 export.
  """
  batch_norm_params = {
      'center': True,
      'scale': True,
...
def extract_features(images,
  ...
  Args:
    ...
    weight_decay: The weight decay for export variables.
    reuse: Reuse the export variables or not.
    ...
    use_bounded_activation: Whether or not to use bounded activations. Bounded
      ...
      bounded activation is only used in xception export.
  ...
  Raises:
    ValueError: Unrecognized export variant.
  """
  if 'resnet' in model_variant:
    ...
    raise ValueError('Unknown export variant %s.' % model_variant)
