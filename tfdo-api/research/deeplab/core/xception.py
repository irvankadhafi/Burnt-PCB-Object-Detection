...
detection challenge submission, where the export is made deeper and has aligned
...
def separable_conv2d_same(inputs,
  ...
  Args:
    ...
    rate: An integer, rate for atrous convolution.
    use_explicit_padding: If True, use explicit padding to make the export fully
...
def xception(inputs,
  ...
  methods for specific export instantiations, obtained by selecting different
