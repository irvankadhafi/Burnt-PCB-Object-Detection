...
def get_model_init_fn(train_logdir,
  ...
  """Gets the function initializing export variables from a checkpoint.

  Args:
    train_logdir: Log directory for training.
    tf_initial_checkpoint: TensorFlow checkpoint for initialization.
    initialize_last_layer: Initialize last layer or not.
    last_layers: Last layers of the export.
  ...
  if tf_initial_checkpoint is None:
    tf.logging.info('Not initializing the export from a checkpoint.')
    return None
  ...
  tf.logging.info('Initializing export from path: %s', tf_initial_checkpoint)
...
def get_model_gradient_multipliers(last_layers, last_layer_gradient_multiplier):
  ...
  The gradient multipliers will adjust the learning rates for export
...
def get_model_learning_rate(learning_policy,
  ...
  """Gets export's learning rate.

  Computes the export's learning rate for different learning policy.
  ...
  Args:
    ...
    base_learning_rate: The base learning rate for export training.
    learning_rate_decay_step: Decay the base learning rate at a fixed step.
    learning_rate_decay_factor: The rate to decay the base learning rate.
    training_number_of_steps: Number of steps for training.
    learning_power: Power used for 'poly' learning policy.
    slow_start_step: Training export with small learning rate for the first
      few steps.
