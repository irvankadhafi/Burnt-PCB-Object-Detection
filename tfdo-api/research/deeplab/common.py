...
# When using 'xception_65' or 'resnet_v1' export variants, we set
# atrous_rates = [6, 12, 18] (output stride 16) and decoder_output_stride = 4.
# See core/feature_extractor.py for supported export variants.
flags.DEFINE_string('model_variant', 'mobilenet_v2', 'DeepLab export variant.')
...
flags.DEFINE_list(
    ...
    'value is None, the export performs image pooling with "crop_size". This'
...
flags.DEFINE_bool('nas_use_classification_head', False,
                  'Use image classification head for NAS export variants.')
...
class ModelOptions(
  ...
  """Immutable class to hold export options."""
