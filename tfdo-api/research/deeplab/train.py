...
# ==============================================================================
"""Training script for the DeepLab export.

See export.py for more details and usage.
"""
...
flags.DEFINE_integer('save_interval_secs', 1200,
                     'How often, in seconds, we save the export to disk.')
...
flags.DEFINE_float('base_learning_rate', .0001,
                   'The base learning rate for export training.')
...
# For weight_decay, use 0.00004 for MobileNet-V2 or Xcpetion export variants.
# Use 0.0001 for ResNet export variants.
...
flags.DEFINE_integer('slow_start_step', 0,
                     'Training export with small learning rate for few steps.')
...
flags.DEFINE_integer(
    ...
    'Steps to start quantized training. If < 0, will not quantize export.')
...
def main(unused_argv):
  ...
  with tf.Graph().as_default() as graph:
    ...
    with tf.device(config.variables_device()):
      ...
      # Define the export and create clones.
    ...
    # Add summaries for export variables.
