...
flags.DEFINE_string('checkpoint_dir', None, 'Directory of export checkpoints.')

# Settings for visualizing the export.
    ...
    for checkpoint_path in checkpoints_iterator:
      ...
      tf.logging.info(
          'Starting visualization at ' + time.strftime('%Y-%m-%d-%H:%M:%S',
                                                       time.gmtime()))
      tf.logging.info('Visualizing with export %s', checkpoint_path)
